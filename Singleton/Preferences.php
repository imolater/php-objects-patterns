 ...
 * Шаблон Singleton
 *
 * Это объектно-ориентированная реализация глобальных переменных.
 * Такие объекты предназначены для сохранения данных, которые должны
 * быть легкодоступны и надежно сохранены, на протяжение всего процесса
 * работы приложения. Например, параметры подключения к БД, пути
 * к файлам, URL сайта, данные запроса и т.д.
 *
